...
class ElectricField(Fields):
    # Electric field generated by the cathode and anode in the Planeterrella setup. No influence of the electrons. 
    def __init__(self, planeterrella: Planeterrella, voltage: float):
        ...
        #TODO : more precise E field calculation based on the geometry of the cathode and anode. For now, we assume point charges for simplicity.
